...
jQuery( document ).ready(function( $ ) {
	...
	jQuery( '.asr-result-evaluate' ).on( 'click', function() {
		...
		var data = {
			...
			'ubc_di_assessment_result_id' : assessment_result_id,
	...
	jQuery( '#di-filter' ).on( 'click', function() {
		...
		if( jQuery( '#diar-group' ).val() !== '' ) {
			tempURL += '&ubc_di_group=' + jQuery( '#diar-group' ).val();
		}
		if( jQuery( '#diar-site' ).val() !== '' ) {
			tempURL += '&ubc_di_site=' + jQuery( '#diar-site' ).val();
		}
		if( jQuery( '#diar-assessment' ).val() !== '' ) {
			tempURL += '&ubc_di_assessment=' + jQuery( '#diar-assessment' ).val();
		}
...
function displayAssessmentEvaluate( assessmentResult, assessmentResultID ) {
  ...
  var container, question, answer, evaluation, notes, notesBox;
  var result = document.getElementById( 'di-assessment-result' );

	for( var i in assessmentResult ) {
		if( assessmentResult.hasOwnProperty( i ) ) {
			...
			if( assessmentResult[i].recordedMultipleChoice.question !== '' ) {
				...
				container = createGeneralElement( 'div', 'di-asr-container' );

				question = createGeneralElement( 'div', 'di-asr-element', assessmentResult[i].recordedMultipleChoice.question );
				container.appendChild( question );

				answer = createGeneralElement( 'div', 'di-asr-element', assessmentResult[i].recordedMultipleChoice.answer );
				container.appendChild( answer );

				evaluation = createGeneralElement( 'div', 'di-asr-element' );
				...
				notes = createGeneralElement( 'div', 'di-asr-element' );
				notesBox = createGeneralElement( 'textarea', 'di-asr-notes', assessmentResult[i].recordedMultipleChoice.notes );
			...
			if( assessmentResult[i].text.question !== '' ) {
				...
				question = createGeneralElement( 'div', 'di-asr-element', assessmentResult[i].text.question );
				container.appendChild( question );

				answer = createGeneralElement( 'div', 'di-asr-element', assessmentResult[i].text.answer );
				container.appendChild( answer );
				...
				notes = createGeneralElement( 'div', 'di-asr-element' );
				notesBox = createGeneralElement( 'textarea', 'di-asr-notes', assessmentResult[i].text.notes );
			...
			if( assessmentResult[i].image.question !== '' ) {
				...
				question = createGeneralElement( 'div', 'di-asr-element', assessmentResult[i].image.question );
				container.appendChild( question );

				answer = createGeneralElement( 'div', 'di-asr-element' );
				answerImage = createGeneralElement( 'img' );
				...
				notes = createGeneralElement( 'div', 'di-asr-element' );
				notesBox = createGeneralElement( 'textarea', 'di-asr-notes', assessmentResult[i].image.notes );
				notes.appendChild( notesBox );
	...
	jQuery( '#asr-result-submitter' ).on( 'click', function() {
		...
		var data = {
			...
			'ubc_di_nonce_field': jQuery( '#di-nonce-field' ).val(),
			'ubc_di_assessment_result_id': assessmentResultID,
